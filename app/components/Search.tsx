...
function Search({setRecipes}) {
  ...
  return (
    <div className='flex items-center justify-center mt-20 mb-4'>
        <input value={search} onChange={(e) => {setSearch(e.target.value)}} className='bg-teal-300 h-10 px-5 pr-rounded-lg text-sm focus:outline-none' type="text" placeholder='Search for a recipe...'/>
